...
public class PlayerController {
    ...
    public ResponseEntity<Player> createPlayer(@RequestBody Player player) {
        ...
        final Integer level = playerService.computeLevel(player.getExperience());
        player.setLevel(level);
        final Integer untilNextLevel = playerService.computeUntilLevelExperience(player.getExperience(), player.getLevel());
